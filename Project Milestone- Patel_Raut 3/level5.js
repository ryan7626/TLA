function startLevel5() {
    ...
    if (levelIndicator) {
      levelIndicator.textContent = "Level 5"; // Update to Level 4
    }
    ...
    currentHint = "Not everything that supports you is here to stay—move quickly, but plan ahead.";
